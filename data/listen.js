...
(async function () {
    ...
    try {
      ...
      for (const dataU of users) {
    	...
    	logger.loader(`BOTJRT BẮT ĐẦU NHẬN LỆNH`);
    } catch (error) {
...
`, "JRT");*/
  logger(`${global.config.ADMINBOT} || BOTJRT is main!!!`, "ADMINBOT INFO");
...
//DEFINE DATLICH PATH
  ...
  return async (event) => {
    ...
    body: `=== 『 THUÊ BOT 』 ===\n━━━━━━━━━━━━━━━━\n[⛔] ➜ Nhóm của bạn chưa thuê bot, Vui lòng thuê bot để tiếp tục sử dụng.\n\n[⚜️] ➜ Liên hệ Admin: Nguyễn Hải Đăng\nhttps://www.facebook.com/NHD.JRT.262`, attachment: (await axios.get((await axios.get(`https://docs-api.jrtxtracy.repl.co/images/anime?apikey=JRTvip_2200708248`)).data.data, {
                    responseType: 'stream'
                })).data
}, event.threadID);
